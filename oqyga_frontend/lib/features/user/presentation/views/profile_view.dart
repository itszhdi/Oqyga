...
import 'package:oqyga_frontend/features/languages/presentation/bloc/language_bloc.dart'; // Не забудьте импортировать LanguageBloc
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Оборачиваем кнопку языка в BlocBuilder
                  BlocBuilder<LanguageBloc, LanguageState>(
                    builder: (context, languageState) {
                      // Получаем текущий код языка из Bloc или из системных настроек
                      final currentCode =
