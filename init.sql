...
-- Name: age_restrictions_age_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Name: cards_token_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Name: organisators; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.organisators OWNER TO postgres;

--
-- TOC entry 218 (class 1259 OID 59650)
-- Name: organisators_organisator_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Name: promocodes_promocode_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
1	Кино	Cinema	Kıno
2	Театры	Theatres	Teatrlar
3	Концерты	Concerts	Konsertter
4	STAND UP	Stand Up	STAND UP
5	Спорт	Sport	Sport
6	Бизнес-форумы	Business Forums	Bıznes-forýmdar
7	Выставки	Exhibitions	Kórmeler
8	Мастер-классы	Master Classes	Master-klasstar
9	Детям	For Kids	Balalarǵa
10	Развлечения	Entertainment	Oıyn-saýyq
\.
...
1	Астана	Astana	Astana
2	Алматы	Almaty	Almaty
3	Актобе	Aktobe	Aqtóbe
4	Актау	Aktau	Aqtaý
5	Караганда	Karaganda	Qaraǵandy
6	Кокшетау	Kokshetau	Kókshetaý
7	Костанай	Kostanay	Qostanaı
8	Павлодар	Pavlodar	Pavlodar
9	Семей	Semey	Semeı
10	Ташкент	Tashkent	Tashkent
11	Тараз	Taraz	Taraz
12	Талдыкорган	Taldykorgan	Taldyqorǵan
13	Шымкент	Shymkent	Shymkent
14	Усть-Каменогорск	Ust-Kamenogorsk	Óskemen
\.
...
49	Сольный стендап-концерт Алексея Квашонкина	2025-10-29	Harat's Pub, Улица Аскар Токпанов, 10	20:00:00	Алексей Квашонкин - один из самых ярких представителей российской стендап-комедии, известный своим циничным и ироничным стилем. Его выступления отличаются остротой, актуальностью и неподдельной самоиронией. В своей программе Алексей поднимет насущные темы, которые близки каждому. Вас ждет вечер чистого, нефильтрованного юмора.	static/eventPhoto/kvashonkin_standup.jpg	450	6	4	1	9	Alexey Kvashonkin Solo Stand-up	Alekseı Kvashonkınniń jeke stendap-konserti	Harat's Pub (Astana)	Harat's Pub (Astana)	Alexey Kvashonkin is one of the brightest representatives of Russian stand-up comedy, known for his cynical and ironic style. His performances are characterized by sharpness, relevance, and genuine self-irony. In his program, Alexey will raise vital topics close to everyone. An evening of pure, unfiltered humor awaits you.	Alekseı Kvashonkın-óziniń qyńyr jáne ıronıalyq stılimen tanymal reseılik stend-ap komedıasynyń eń kórnekti ókilderiniń biri. Onyń qoıylymdary ótkirligimen, ózektiligimen jáne shynaıy ózin-ózi ıronıasymen erekshelenedi. Alekseı óz baǵdarlamasynda barlyǵyna jaqyn ózekti taqyryptardy kóteredi. Sizdi taza, súzgisiz ázil-ospaq keshi kútedi.
78	AI Conf 2025 Dushanbe	2025-10-25	Crowne Plaza Hotel, просп. Кабанбай Батыра 30	09:00:00	Будущее искусственного интеллекта не просто обсуждается, оно создаётся здесь и сейчас! Глобальный диалог об ИИ с участием новаторов, полисимейкеров и лидеров индустрии из более чем 30 стран. (Место проведения: Душанбе).	static/eventPhoto/ai_conf.jpg	800	5	6	1	16	AI Conf 2025 Dushanbe	AI Conf 2025 Dýshanbe	Crowne Plaza Hotel, Dushanbe EXPO	Crowne Plaza Hotel, Dushanbe EXPO	The future of artificial intelligence is not just being discussed, it is being created here and now! A global dialogue on AI featuring innovators, policymakers, and industry leaders from over 30 countries. (Location: Dushanbe).	Jasandy ıntellekttiń bolashaǵy jaı ǵana talqylanbaıdy, ol osynda jáne qazir jasalady! 30-dan astam eldiń ınnovatorlary, polısımeıkerleri jáne ındýstrıa kóshbasshylary qatysatyn ai týraly jahandyq dıalog. (Ótetin orny: Dýshanbe).
46	Севак Ханагян в Астане	2025-10-18	Отель Rixos President Astana, Улица Динмухамед Конаев, 7	20:00:00	Севак Ханагян — армянский и российский певец, автор песен, победитель шоу «Главная сцена», участник «Голоса», наставник «Голоса Армении» и победитель «Х-Фактор-7». Песни Севака Ханагяна пронизаны глубокими эмоциями и лирикой, которые находят отклик в сердцах слушателей. Зрителей ждет чувственный вечер, наполненный любимыми хитами, такими как «Не молчи», «Когда мы с тобой», «Добро пожаловать» и новыми композициями.	static/eventPhoto/sevak_khanagyan.jpg	1000	3	3	1	4	Sevak Khanagyan in Astana	Astanadaǵy Sevak Hanagıan	Rixos President Astana Hotel	Rixos President Astana Hotel	Sevak Khanagyan is an Armenian and Russian singer, songwriter, winner of the "Main Stage" show, participant of "The Voice", mentor of "The Voice of Armenia" and winner of "X-Factor-7". Sevak's songs are permeated with deep emotions and lyrics that resonate in the hearts of listeners. A sensual evening awaits the audience, filled with beloved hits like "Don't be silent", "When we are together", and new compositions.	Sevak Hanagán-armán jáne orys ánshisi, án avtory, "basty sahna" shoýynyń jeńimpazy, "daýystyń" qatysýshysy, "Armenıa daýysynyń" tálimgeri jáne "H-faktor-7"jeńimpazy. Sevak Hanagánnyń ánderi tyńdaýshylardyń júreginde rezonans týdyratyn tereń emosıalar men lırıkalarǵa toly. Kórermender "únsiz qalmańyz", "biz Sizben bolǵan kezde", "qosh keldińiz" jáne jańa kompozısıalar sıaqty súıikti hıtterge toly sezimtal keshti kútedi.
59	Истребитель демонов: Kimetsu No Yaiba Бесконечная крепость (2025)	2025-10-15	Chaplin Mega Silk Way, просп. Кабанбай Батыра 62	11:00:00	Тандзиро Камадо — юноша, который вступил в организацию, занимающуюся истреблением демонов, под названием «Корпус истребителей демонов», после того как его младшая сестра Нэдзуко превратилась в демона. Становясь сильнее и укрепляя дружбу и связи с другими членами Корпуса, Тандзиро сражался с множеством демонов вместе со своими товарищами — Дзэницу Агацума и Иноскэ Хибасира. В ходе своего пути он сражался плечом к плечу с высшими мечниками Корпуса — столпами (Хашира), включая столп Пламени Кёдзюро Рэнгоку на «Бесконечном поезде», столп Звука Тэнгэн Узуи в квартале красных фонарей, а также столп Тумана Муичиро Токито и столп Любви Мицури Канродзи в Деревне кузнецов. Когда члены Корпуса и Хашира начали совместную программу силовых тренировок  —Тренировку столпов, чтобы подготовиться к предстоящей битве с демонами, Мудзан Кибуцудзи появляется в особняке Убуяшики. Когда глава Корпуса оказывается в опасности, Тандзиро и столпы спешат на помощь в штаб-квартиру, но оказываются сброшены в таинственное пространство самим Мудзаном Кибуцудзи. Местом, куда упали Тандзиро и члены Корпуса, становится цитадель демонов — Бесконечный замок. И вот, поле боя готово, и финальная битва между Корпусом истребителей демонов и демонами начинается.	static/eventPhoto/истребитель_демонов.jpg	200	3	1	1	1	Demon Slayer: Kimetsu no Yaiba - Infinity Castle (2025)	Demon slayer: Kimetsu no Yaiba sheksiz bekinis (2025)	Chaplin Mega Silk Way	Chaplin Mega Silk Way	Tanjiro Kamado joins the Demon Slayer Corps after his sister Nezuko turns into a demon. The Corps and the Hashira begin a rigorous training program to prepare for the upcoming battle against demons. However, Muzan Kibutsuji appears at the Ubuyashiki mansion. When the leader of the Corps is in danger, Tanjiro and the Hashira rush to help but are dropped into a mysterious space by Muzan himself—the Infinity Castle. The final battle begins.	Tanjıro Kamado-kishi ápkesi Nezýko jyn-perilerge aınalǵannan keıin "jyn-periler korpýsy" dep atalatyn jyndardy joıý uıymyna kirgen jas jigit. Tandjıro kúsheıip, korpýstyń basqa múshelerimen dostyq pen baılanysty nyǵaıta otyryp, kóptegen jyndarmen birge joldastarymen — Dzenısý Agatsýma jáne Inoske Hıbasıramen shaıqasty. Sapar barysynda ol korpýstyń eń joǵary qylyshshylarymen — tirektermen (Hashıra), sonyń ishinde "sheksiz poıyzda" Kedzúro Rangoký jalyn baǵanymen, qyzyl shamdar blogyndaǵy Tengeng Ýzýı dybystyq baǵanymen, sondaı-aq Mýıchıro Tokıto tumanynyń baǵanymen jáne temir ustalary aýylyndaǵy Mısýrı Kanrodzıdiń Mahabbat baǵanymen ıyqpen shaıqasty. Korpýs músheleri men Hashıra kúsh jattyǵýlarynyń birlesken baǵdarlamasyn bastaǵan kezde —aldaǵy jyndarmen shaıqasqa daıyndalý úshin tirekterdi jattyqtyrý, Mýdzan Kıbýsýdzı Ýbýıashıkı saraıynda paıda bolady. Korpýs basshysyna qaýip tóngen kezde, tandjıro men tirekter shtab-páterge kómekke asyǵady, biraq Mýdzan Kıbýsýdzıdiń ózi jumbaq keńistikke tastalady. Tandjıro men korpýs músheleri qulaǵan jer-jyndar sıtadeli-sheksiz qulyp. Mine, pole alańy daıyn jáne jyn-periler Korpýsy men jyndar arasyndaǵy sońǵy shaıqas bastalady.
73	Арт-вечеринка от студии Michael Art в Шымкенте	2025-11-08	Ресторан "The paragon" ул.Байдибек би 229	17:00:00	Мы приглашаем тебя провести с нами самое яркое и эксклюзивное событие этого года Арт-вечеринку от студии Michael Art.	static/eventPhoto/арт_вечеринка.jpg	20	3	8	13	7	Art Party by Michael Art Studio in Shymkent	Shymkenttegi Michael Art stýdıasynyń Art-keshi	The Paragon Restaurant, Baidibek Bi St 229	"Paragon" Meıramhanasy, Báıdibek Bı Kóshesi, 229	We invite you to spend the brightest and most exclusive event of this year with us - the Art Party from Michael Art studio.	Biz sizdi Maıkl art stýdıasynyń bıylǵy eń jarqyn jáne eksklúzıvti óner keshin bizben birge ótkizýge shaqyramyz.
50	Собор Парижской Богоматери	2025-10-29	Astana Opera, ул. Динмухамеда Кунаева 1	19:00:00	Балет в двух действиях по мотивам одноименного романа Виктора Гюго. Это произведение — бессмертная история о любви, красоте и уродстве, сострадании и жестокости. Хореография передает всю драматическую силу романа, а декорации и костюмы погружают в атмосферу средневекового Парижа. На сцене выступят ведущие солисты театра Astana Opera.	static/eventPhoto/sobor_parizhskoy_bogomateri.jpg	1200	3	2	1	11	Notre Dame de Paris	Parıj Qudaı anasy sobory	Astana Opera	Astana Opera	Ballet in two acts based on the novel by Victor Hugo. This work is an immortal story about love, beauty and ugliness, compassion and cruelty. The choreography conveys all the dramatic power of the novel, and the sets and costumes immerse you in the atmosphere of medieval Paris. Leading soloists of the Astana Opera theatre will perform on stage.	Vıktor Gúgonyń attas romanyna negizdelgen eki aktili Balet. Bul shyǵarma mahabbat, sulýlyq pen usqynsyzdyq, janashyrlyq pen qatygezdik týraly ólmes oqıǵa. Horeografıa romannyń barlyq dramalyq Kúshin jetkizedi, al jıyntyqtar men kostúmder ortaǵasyrlyq Parıj atmosferasyna enedi. Sahnada Astana Opera teatrynyń jetekshi solıseri óner kórsetedi.
74	Массовое посещение бассейна в СК «Бурабай»	2025-10-16	Ледовый дворец «Бурабай», Бассейн	08:00:00	Массовое посещение бассейна в Спортивном комплексе «Бурабай». Дети до 7 лет в маленьком бассейне с родителями. Вместимость - 50 человек за 1 час.	static/eventPhoto/basseyn_burabay.jpg	50	1	5	6	3	Public Swimming at "Burabay" Sports Complex	"Býrabaı" SK baseınine jappaı barý	Burabay Ice Palace, Swimming Pool	Býrabaı Muz Saraıy, Baseın	Mass visit to the swimming pool at the "Burabay" Sports Complex. Children under 7 years old in a small pool with parents. Capacity - 50 people per 1 hour.	"Býrabaı" sport keshenindegi baseınge jappaı barý. 7 jasqa deıingi balalar ata-analarymen birge shaǵyn baseınde. Syıymdylyǵy-1 saǵat ishinde 50 adam.
65	MÁNSHÚK	2025-10-17	Музыкальный театр юного зрителя, ул. Ж. Омарова 47б	19:00:00	Ұлы Жеңістің 80 жылдығына орай, Астана қаласы әкімдігінің Музыкалық жас көрермен театрында Кеңес Одағының Батыры, қазақтың қаһарман қызы Мәншүк Мәметованың қысқа әрі қайсарлыққа толы өмірін бейнелейтін «Мәншүк» музыкалық драма сахналанады. Қойылымның мақсаты есімі аңызға айналған, ерлік істері барша ұлтты таң қалдырған қазақтың батыр қызы жарқын өмірін, Ұлы Отан соғысындағы ерлік істерін ұрпаққа үлгі етіп, өнеге ету. Туынды тарихи деректерге негізделген.	static/eventPhoto/маншук.jpg	150	3	2	1	18	MANSHUK	MÁNSHÚK	Musical Theatre of Young Spectators	Mýzykalyq jas kórermender teatry	In honor of the 80th anniversary of the Great Victory, the Musical Drama "Manshuk" depicting the short and courageous life of the Hero of the Soviet Union, the heroic Kazakh daughter Manshuk Mametova, is being staged. The purpose of the production is to set the bright life of the Kazakh heroine and her heroic deeds in the Great Patriotic War as an example for the younger generation. The work is based on historical facts.	Uly Jeńistiń 80 jyldyǵyna oraı, Astana qalasy ákimdiginiń Mýzykalyq jas kórermen teatrynda Keńes Odaǵynyń Batyry, qazaqtyń qaharman qyzy Mánshúk Mámetovanyń qysqa ári qaısarlyqqa toly ómirin beıneleıtin "Mánshúk" mýzykalyq drama sahnalanady. Qoıylymnyń maqsaty esimi ańyzǵa aınalǵan, erlik isteri barsha ultty tań qaldyrǵan qazaqtyń batyr qyzy jarqyn ómirin, Uly Otan soǵysyndaǵy erlik isterin urpaqqa úlgi etip, ónege etý. Týyndy tarıhı derekterge negizdelgen.
76	Цирк Шапито ELDORADO в Семее	2025-10-18	Цирк Шапито Семей	16:00:00	Цирк Шапито «EldoradO» с программой «Морское Чудо». 100 минут незабываемого ШОУ: акробатические трюки, группа экзотических животных (морской заяц «ЧАРЛИ», крокодил «Варя», змеи), дрессированные Ротвейлеры.	static/eventPhoto/tsirk_eldorado.jpg	1000	1	9	9	18	ELDORADO Big Top Circus in Semey	Semeıdegi "ELDORADO" Úlken Top Sırki	Semey Big Top Circus	Semeı Qalasynyń Úlken Top Sırki	Big Top Circus "EldoradO" with the program "Sea Miracle". 100 minutes of an unforgettable SHOW: acrobatic stunts, a group of exotic animals (sea hare "CHARLIE", crocodile "Varya", snakes), trained Rottweilers.	"EldoradO" shapıto sırki "teńiz keremeti" baǵdarlamasymen. 100 mınýttyq umytylmas SHOÝ: akrobatıkalyq trúkter, ekzotıkalyq janýarlar toby ("CHARLI" teńiz qoıany, "Vará" qoltyraýyn, jylandar), úıretilgen Rotveıler.
61	Jumbaq qyz (2025)	2025-10-25	Chaplin Khan Shatyr, Проспект Туран, 37	12:45:00	Әкесі өмірден өткеннен кейін Айару депрессияға түсіп, өзін жоғалтып алғандай. Құмар ойынға қызығып, соның ізіне түскенін көргенде анасы мен ағасы қатаң шара қолданады. Ауылдағы әкесі негізін қалаған фермаға апарып тастайды. Айару ауылдың тыныш атмосферасына үйреніп, ферманың жұмысын жандандыруға қызу кіріседі. Бұрын тұнжырап, тек өз әлемінде жүретін қыз жадырап сала береді. Бұлай болуына әсер еткен негізгі бір себеп – махаббат. Фермадағы жеке жүргізушісі Шыңғыс екеуінің арасындағы ұрыс-керістен басталған қарым-қатынас уақыт өте келе тәтті сезімге ұласады. Шыңғыс ауылдағы қызы Нұршатпен сөз байласып, той күнін белгілеп қойған болатын. Ауқатты, ықпалды кісінің қызы Нұршат өз махаббатын біреуге оңай бере салатын адам емес. Шыңғыс қорқақтық танытып сезіміне сатқындық жасай ма, әлде елдің әңгімесін ысырып қойып, сүйіктісі Айарумен қосыла ма? Осылайша, Айару тыныштық табамын ба деп барған ауылда да шытырман оқиға тап болады.  Бұл жердегі «ставканың» құны тым жоғары..	static/eventPhoto/жумбак_кыз.jpg	200	5	1	1	1	Mysterious Girl (2025)	Jumbaq qyz (2025)	Chaplin Khan Shatyr	Chaplin Khan Shatyr	After her father passes away, Ayaru falls into depression and seems to lose herself. When her mother and brother see her getting into gambling, they take strict measures. They take her to the farm in the village founded by her father. Ayaru gets used to the quiet atmosphere of the village and vigorously begins to revitalize the farm's work. The main reason for this change is love. The relationship between her and her personal driver on the farm, Shyngys, starts with quarrels but turns into sweet feelings over time. However, Shyngys is engaged to a girl named Nurshat. The stakes are high...	Ákesi ómirden ótkennen keıin Aıarý depressıaǵa túsip, ózin joǵaltyp alǵandaı. Qumar oıynǵa qyzyǵyp, sonyń izine túskenin kórgende anasy men aǵasy qatań shara qoldanady. Aýyldaǵy ákesi negizin qalaǵan fermaǵa aparyp tastaıdy. Aıarý aýyldyń tynysh atmosferasyna úırenip, fermanyń jumysyn jandandyrýǵa qyzý kirisedi. Buryn tunjyrap, tek óz áleminde júretin qyz jadyrap sala beredi. Bulaı bolýyna áser etken negizgi bir sebep – mahabbat. Fermadaǵy jeke júrgizýshisi Shyńǵys ekeýiniń arasyndaǵy urys-keristen bastalǵan qarym-qatynas ýaqyt óte kele tátti sezimge ulasady. Shyńǵys aýyldaǵy qyzy Nurshatpen sóz baılasyp, toı kúnin belgilep qoıǵan bolatyn. Aýqatty, yqpaldy kisiniń qyzy Nurshat óz mahabbatyn bireýge ońaı bere salatyn adam emes. Shyńǵys qorqaqtyq tanytyp sezimine satqyndyq jasaı ma, álde eldiń áńgimesin ysyryp qoıyp, súıiktisi Aıarýmen qosyla ma? Osylaısha, Aıarý tynyshtyq tabamyn ba dep barǵan aýylda da shytyrman oqıǵa tap bolady.  Bul jerdegi "stavkanyń" quny tym joǵary.
91	Anacondaz 	2026-03-09	Garden Hall Astana	19:00:00	Anacondaz едут в Астану с презентацией альбома «Ночь с астраханцем»\n\n«Ночь с астраханцем» - первый релиз после длительного четырёхлетнего перерыва и восьмой полноформатный альбом за шестнадцатилетнюю творческую карьеру группы.	/uploads/event_posters/42ba3b4b-1a4b-4dae-b0f3-29abbc9f4603.jpg	139	1	3	1	21	Anacondaz	Anacondaz	Garden Hall Astana	Garden Hall Astana	Anacondaz is coming to Astana to present their new album "Night with an Astrakhanian". This is their first release after a long four-year hiatus and the eighth full-length album in the group's sixteen-year creative career.	Anacondaz Astanaǵa "Astrahan túni"álbomynyń tusaýkeserimen barady\n\n"Astrahan túni" - bul uzaq tórt jyldyq úzilisten keıingi alǵashqy shyǵarylym jáne toptyń on alty jyldyq shyǵarmashylyq mansabyndaǵy segizinshi tolyq metrajdy álbom.
77	Выставка «Пабло Пикассо. Параграфы»	2025-10-16	Галерея LM Kulanshi Art, Улица Касыма Аманжолова, 22а	10:00:00	Самое громкое имя в искусстве XX века - на выставке от музея Lumiere-Hall. Неистовый гений, создавший десятки тысяч произведений, величайший новатор современности.	static/eventPhoto/pikasso_paragraphs.jpg	500	1	7	1	7	Exhibition "Pablo Picasso. Paragraphs"	«Pablo Pıkasso. Paragraftar» kórmesi	LM Kulanshi Art Gallery	LM Kulanshi Art galereıasy	The loudest name in 20th-century art - at the exhibition from the Lumiere-Hall Museum. A frantic genius who created tens of thousands of works, the greatest innovator of modern times.	HH ǵasyrdaǵy ónerdegi eń úlken esim-Lumiere-Hall murajaıynyń kórmesinde. On myńdaǵan týyndylardy jasaǵan ashýly danyshpan, qazirgi zamannyń eń uly jańashyly.
41	Zoloto в Астане	2025-11-23	Конгресс центр, Улица Гейдара Алиева, 12	20:00:00	ZOLOTO – это сольный проект Владимира Золотухина, автора, фронтмена и мультиинструменталиста, исполняющего «фешенебельную эстраду» с ностальгическим звучанием, вне времени. Его музыка сочетает инди-поп с элементами диско и ностальгическими отсылками к поп-культуре 90-х и 00-х, создавая атмосферу подлинной внутренней свободы и любви. В составе группы — опытные музыканты: Герман Тигай (бас), Даниил Морозов (барабаны) и Игорь Грибов (гитара/клавиши). У ZOLOTO четыре альбома, включая последний, «Перевоплотиться» (2024), который стал полностью гитарным и вошел в мировые ТОП-чарты. Живые выступления группы, включая глубокий акустический блок, дарят слушателям настоящий катарсис.	static/eventPhoto/zoloto_concert.jpg	2102	5	3	1	4	Zoloto in Astana	Astanadaǵy Zoloto	Congress Center	Kongress-ortalyǵy	ZOLOTO is the solo project of Vladimir Zolotukhin, an author, frontman, and multi-instrumentalist performing "fashionable pop" with a timeless, nostalgic sound. His music combines indie-pop with disco elements and nostalgic references to the pop culture of the 90s and 00s. The band includes experienced musicians: German Tigay (bass), Daniil Morozov (drums), and Igor Gribov (guitar/keys). ZOLOTO has four albums, including the latest "Reincarnate" (2024).	Zoloto-avtor, frontmen jáne kóp aspapty Vladımır Zolotýhınniń jeke jobasy, ol "sándi sahnany" saǵynyshpen oryndaıdy, eskirmeıdi. Onyń mýzykasy ındı-popty dıskoteka elementterimen jáne 90-00-shi jyldardaǵy pop-mádenıetke nostalgıalyq siltemelermen biriktirip, shynaıy ishki erkindik pen mahabbat atmosferasyn jasaıdy. Top quramynda tájirıbeli mýzykanttar bar: German Tıgaı (bas), Danııl Morozov (barabandar) jáne Igor Grıbov (gıtara/kiltter). ZOLOTO-da tórt álbom bar, sonyń ishinde sońǵysy, "reınkarnasıa" (2024), ol tolyǵymen gıtaraǵa aınaldy jáne álemdik TOP-charttarǵa endi. Toptyń tiri qoıylymdary, sonyń ishinde tereń akýstıkalyq blok, tyńdaýshylarǵa naǵyz katarsıs beredi.
75	Спектакль «Qobylandy»	2025-10-16	Драмтеатр им. Т. Ахтанова	18:30:00	Спектакль "Кобыланды" по мотивам произведения. Жанр: Ауыз әдебиеті. Режиссер: Дина Жұмабаева.	static/eventPhoto/kobylandy_batyr.jpg	400	3	2	3	15	Play "Kobylandy"	«Qobylandy» spektakli	T. Akhtanov Drama Theatre	T. Ahtanov Atyndaǵy Drama Teatry	Play "Kobylandy" based on the work. Genre: Oral literature / Folklore. Director: Dina Zhumabayeva.	Aýyz ádebıeti jelisi boıynsha qoıylǵan «Qobylandy» spektakli. Rejısseri — Dına Jumabaeva.
69	PGL Astana 2026 (Киберспорт)	2026-05-15	Барыс Арена, просп. Туран 57	08:00:00	После оглушительного успеха PGL Astana в 2025 году, когда зрители в столице Казахстана стали свидетелями захватывающего турнира уровня Tier-1 по Counter-Strike и отпраздновали победу Team Spirit, PGL возвращаются с еще одним событием, которое обязательно нужно посетить: PGL Astana 2026!	static/eventPhoto/pgl_astana.jpg	10000	5	5	1	20	PGL Astana 2026 (Esports)	PGL Astana 2026	Barys Arena	Barys Arena	After the resounding success of PGL Astana in 2025, when viewers in the capital of Kazakhstan witnessed a thrilling Tier-1 Counter-Strike tournament and celebrated Team Spirit's victory, PGL returns with another must-visit event: PGL Astana 2026!	2025 jyly PGL Astana-nyń tańǵalarlyq tabysynan keıin, Qazaqstan astanasyndaǵy kórermender Counter-Strike boıynsha Tier-1 deńgeıindegi qyzyqty týrnırdiń kýási bolyp, team Spirit jeńisin atap ótken kezde, PGL mindetti túrde kelýge tıis taǵy bir oqıǵamen oralady: PGL Astana 2026!
40	Сольный концерт группы MOLDANAZAR	2025-11-22	Казахконцерт им. Розы Баглановой, Проспект Мангилик Ел, 10/1	19:30:00	22 ноября на сцене Казахконцерта им. Розы Баглановой состоится уникальный концерт группы Moldanazar в новом формате. Впервые любимые хиты прозвучат в сопровождении симфонического оркестра, придавая им особую глубину и масштабность. Зрителей ждет неповторимое сочетание синти-попа, инди-рока и авторской подачи, за которые коллектив полюбился тысячам поклонников. Прозвучат проникновенные композиции Ozin gana, Alystama, Aqpen Birge и многие другие песни, ставшие визитной карточкой группы.	static/eventPhoto/moldanazar.jpg	3500	5	3	1	2	MOLDANAZAR Solo Concert	MOLDANAZARDYŃ Jeke Konserti	Roza Baglanova Kazakh Concert Hall, Mangilik Yel Ave, 10/1	Roza Baǵlanova Atyndaǵy Qazaq Konsert Zaly, Máńgilik El Dańǵyly, 10/1	On November 22, a unique concert by the band Moldanazar will take place in a new format at the Roza Baglanova Kazakh Concert Hall. For the first time, beloved hits will be performed with a symphony orchestra, giving them special depth and scale. The audience can expect a unique combination of synth-pop, indie-rock, and original style. Soulful compositions like Ozin gana, Alystama, Aqpen Birge, and many others will be performed.	22 qarashada Qazaqkonsert sahnasynda. Roza Baǵlanova Moldanazar tobynyń biregeı konsertin jańa formatta ótkizedi. Alǵash ret súıikti hıtter sımfonıalyq orkestrdiń súıemeldeýimen oryndalady, olarǵa erekshe tereńdik pen masshtab beredi. Kórermenderdi sıntı-pop, ındı-rok jáne avtorlyq prezentasıanyń erekshe úılesimi kútedi, olar úshin ujym myńdaǵan jankúıerlerdi jaqsy kórdi. Toptyń vızıt kartochkasyna aınalǵan Ozin Gana, Alystama, Aqpen Birge jáne basqa da kóptegen ánder shyrqalady.
47	ФК «Астана» - ФК «Актобе»	2025-10-19	Астана Арена, просп. Туран 48	17:00:00	Футбольный матч между командами «Астана» и «Актобе» в рамках чемпионата Казахстана. Нас ждет захватывающая встреча двух сильнейших клубов, которые продемонстрируют свое мастерство и волю к победе. Приходите поддержать свою любимую команду и насладиться атмосферой настоящего футбольного праздника.	static/eventPhoto/fc_astana_aktobe.png	30000	2	5	1	17	FC Astana - FC Aktobe	«Astana» FK - «Aqtóbe» FK	Astana Arena	«Astana Arena» stadıony	Football match between "Astana" and "Aktobe" teams within the framework of the Kazakhstan Championship. We are waiting for an exciting meeting of two strongest clubs that will demonstrate their skills and will to win. Come to support your favorite team and enjoy the atmosphere of a real football holiday.	Qazaqstan chempıonaty aıasynda "Astana" men "Aqtóbe" komandalary arasyndaǵy fýtbol machy. Bizdi eki myqty klýbtyń qyzyqty kezdesýi kútip tur, olar ózderiniń sheberlikteri men jeńiske degen erik-jigerin kórsetedi. Ózińizdiń súıikti komandańyzǵa qoldaý kórsetip, naǵyz fýtbol merekesiniń atmosferasyn tamashalańyz.
60	Мир в огне (2025)	2025-10-02	Chaplin Mega Silk Way, просп. Кабанбай Батыра 62	11:00:00	Дэйв Батиста, Ольга Куриленко и Сэмюэл Л.Джексон в фантастической экшн-комедии про ограбление в разгар апокалипсиса. После мощной солнечной вспышки, уничтожившей восточное полушарие. Земли, мир погрузился в хаос. Посреди всего безумия охотник за сокровищами отправляется на самое дерзкое ограбление своей жизни. Ему предстоит украсть «Мону Лизу», теперь сокрытую в самом опасном месте на планете, а также между делом спасти мир (если получится).	static/eventPhoto/мир_в_огне.jpg	200	6	1	1	1	World in Fire (2025)	Jalyn qushaǵyndaǵy álem (2025)	Chaplin Mega Silk Way	Chaplin Mega Silk Way	Dave Bautista, Olga Kurylenko, and Samuel L. Jackson in a fantastic action-comedy about a heist in the midst of the apocalypse. After a powerful solar flare destroys the Eastern Hemisphere, the world plunges into chaos. Amidst all the madness, a treasure hunter sets off on the most daring heist of his life. He has to steal the "Mona Lisa", now hidden in the most dangerous place on the planet, and also save the world along the way (if possible).	Deıv Batısta, Olga Kýrılenko jáne Semúel L.Djekson aqyrzamannyń ortasynda tonaý týraly fantasıkalyq ekshn-komedıada. Shyǵys jarty shardy joıǵan qýatty kún sáýlesinen keıin. Jer, álem haosqa batyp ketti. Barlyq aqylsyzdyqtyń ortasynda qazyna izdeýshi óz ómiriniń eń batyl tonaýyna barady. Ol qazir planetanyń eń qaýipti jerinde jasyrylǵan" Mona Lızany", sondaı-aq álemdi qutqarý úshin (eger ol jumys istese) urlaýy kerek.
52	Сольный Stand Up концерт Сауле Юсуповой	2025-11-08	Almaty Theatre	19:00:00	Сольный Stand Up концерт Сауле Юсуповой в Алматы! Сауле - одна из самых популярных стендап-комиков, известная своим уникальным стилем и жизненными наблюдениями, которые она превращает в искрометные шутки. Приготовьтесь к вечеру, полному откровенного и смешного юмора. Возрастное ограничение: 18+.	static/eventPhoto/saule_yusupova.jpg	800	6	4	2	9	Saule Yusupova Solo Stand Up Concert	Sáýle Iýsýpovanyń Jeke Stand Up Konserti	Almaty Theatre	Almaty Theatre	Saule Yusupova's Solo Stand Up Concert in Almaty! Saule is one of the most popular stand-up comedians, known for her unique style and life observations, which she turns into sparkling jokes. Get ready for an evening full of frank and funny humor. Age restriction: 18+.	Saýle Iýsýpovanyń Almatydaǵy jeke stand up konserti! Sáýle-eń tanymal stend-ap komedıalarynyń biri, óziniń erekshe stılimen jáne ómirdegi baqylaýlarymen tanymal, ol ony jarqyraǵan ázilderge aınaldyrady. Ashyq jáne kúlkili ázilge toly keshke daıyndalyńyz. Jas shekteýi: 18+.
42	Диана Арбенина в Караганде	2025-11-07	Центр бокса им. С. Сапиева	19:00:00	Долгожданное возвращение! 7 ноября 2025 года Диана Арбенина и группа «Ночные Снайперы» вновь выйдут на сцену Центра бокса им. С. Сапиева в Караганде. Поклонников ждет вечер настоящего рок-н-ролла, наполненный невероятной энергетикой и пронзительной лирикой. Прозвучат как легендарные хиты, проверенные временем, так и новые композиции. Это событие отличная возможность вновь ощутить мощь живого выступления одной из главных рок-исполнительниц и услышать любимые песни вживую.	static/eventPhoto/diana_arbenina.jpg	1500	3	3	5	12	Diana Arbenina in Karaganda	Dıana Arbenına Qaraǵandyda	S. Sapiyev Boxing Center	S. Sapıev Atyndaǵy Boks Ortalyǵy	A long-awaited return! On November 7, 2025, Diana Arbenina and the "Night Snipers" band will take the stage at the S. Sapiyev Boxing Center in Karaganda. Fans can expect an evening of real rock and roll, filled with incredible energy and poignant lyrics. Both legendary hits and new compositions will be performed.	Kópten kútken oralý! 2025 jyldyń 7 qarashasynda Dıana Arbenına men "túngi mergender" toby boks ortalyǵynyń sahnasyna qaıta shyǵady. S. Sápıeva Qaraǵandyda. Jankúıerlerdi keremet energıamen jáne pırsıngtik lırıkamen toltyrylǵan naǵyz rok-n-roll keshi kútedi. Ańyzǵa aınalǵan hıtter de, ýaqyt synynan ótken de, jańa kompozısıalar da oryndalady. Bul is-shara basty rok-oryndaýshylardyń biriniń jandy daýysta óner kórsetýiniń kúshin qaıta sezinýge jáne súıikti ánderińizdi jandy daýysta tyńdaýǵa tamasha múmkindik.
44	The Universe of Hans Zimmer	2025-10-27	Дворец культуры им. И. Жансугурова	19:00:00	На сцене более 30 музыкантов оркестра и хора исполнят музыку одного из самых известных, популярных и влиятельных кинокомпозиторов современности - Ханса Циммера. Он оказал колоссальное влияние на новейшую историю голливудского кино и поп-культуру в целом. А также, благодаря его музыке большинство фильмов получили ту самую известность, которую имеют сейчас. В программе концерта: «Дюна 1 и 2», «Интерстеллар», «Бэтман»,«Гладиатор», «Начало», «Кунг-Фу Панда», «Пираты Карибского моря», «Король Лев», «Шерлок Холмс» , «Мадагаскар», «Перл-Харбор», «Последний Самурай», «Человек из стали», «Call of Duty». Вас ждёт колоссальный живой звук под видеоряд в исполнении большого симфонического оркестра и хора.	static/eventPhoto/the_universe_of_hans_zimmer.jpg	1250	2	3	12	8	The Universe of Hans Zimmer	Hans Sımmer álemi (The Universe of Hans Zimmer)	I. Zhansugurov Palace of Culture	I. Jansúgirov Atyndaǵy Mádenıet Saraıy	More than 30 musicians of the orchestra and choir will perform the music of one of the most famous and influential film composers of our time - Hans Zimmer. The program includes music from: Dune 1 & 2, Interstellar, Batman, Gladiator, Inception, Kung Fu Panda, Pirates of the Caribbean, The Lion King, Sherlock Holmes, Madagascar, Pearl Harbor, The Last Samurai, Man of Steel, Call of Duty.	Sahnada 30 - dan astam orkestr men hor mýzykanttary qazirgi zamannyń eń tanymal, tanymal jáne yqpaldy kınokompozıtorlarynyń biri-Hans Sımmerdiń mýzykasyn oryndaıdy. Bul gollıvýd kınosynyń sońǵy tarıhyna jáne jalpy pop-mádenıetke úlken áser etti. Sondaı-aq, onyń mýzykasynyń arqasynda fılmderdiń kópshiligi qazirgi kezdegi dańqqa ıe boldy. Konsert baǵdarlamasynda: "Dún 1 jáne 2", "Stellar aralyq","Betmen", "Gladıator", "bastaý", "Kýng-Fý Panda", "Karıb teńiziniń qaraqshylary", "Arystan patsha" , "Sherlok Holms", "Madagaskar", "Perl-Harbor", "Sońǵy Samýraı", "Bolat adamy", "Call Of Duty". Sizdi úlken sımfonıalyq orkestr men hordyń oryndaýyndaǵy beıne qatarǵa arnalǵan úlken jandy dybys kútedi.
48	«Алма-Ата 89»	2025-10-23	ARTиШОК театр	19:00:00	Спектакль «Алма-Ата 89» в театре ARTиШОК - это попытка реконструировать и осмыслить события 1989 года. Постановка является размышлением о переломном моменте в истории, о судьбах людей и о том, как прошлое влияет на настоящее. Зрителей ждет глубокое погружение в атмосферу того времени через игру актеров и уникальную сценографию.	static/eventPhoto/alma_ata_89.jpg	300	6	2	2	6	"Alma-Ata 89"	"Alma-Ata 89"	ARTiSHOCK Theatre	Artıshok Teatry	The play "Alma-Ata 89" at the ARTiSHOCK Theatre is an attempt to reconstruct and comprehend the events of 1989. The production is a reflection on a turning point in history, on the fates of people, and on how the past influences the present. The audience awaits a deep immersion into the atmosphere of that time through the acting and unique set design.	Artıshok teatryndaǵy" Alma-Ata 89 " spektakli - 1989 jylǵy oqıǵalardy qaıta jańǵyrtý jáne túsiný áreketi. Qoıylym-bul oqıǵanyń betburys kezeńi, adamdardyń taǵdyry jáne ótkenniń qazirgi ýaqytqa qalaı áser etetini týraly refleksıa. Kórermenderdi akterler oıyny men erekshe senografıa arqyly sol kezdegi atmosferaǵa tereń ený kútedi.
51	AStudio в Алматы	2025-11-07	Дворец Республики	20:00:00	Главное музыкальное событие осени! Легендарная группа A'STUDIO вновь в Алматы! 7 ноября 2025 года на сцене Дворца Республики прозвучат любимые хиты, которые покорили сердца миллионов, такие как «Джулия», «Улетаю» и многие другие. Невероятная атмосфера, живой звук и самые душевные песни ждут вас в этот вечер!	static/eventPhoto/a_studio.jpg	3000	2	3	2	25	A'Studio in Almaty	Almatıdaǵy AStudio	Palace of the Republic	Respýblıka saraıy	The main musical event of the autumn! The legendary group A'STUDIO is back in Almaty! On November 7, 2025, beloved hits that conquered the hearts of millions, such as "Julia", "Fly Away" (Uletayu) and many others, will be performed on the stage of the Palace of the Republic. Incredible atmosphere, live sound and the most soulful songs await you this evening!	Kúzdiń basty mýzykalyq oqıǵasy! Almatyda aty ańyzǵa aınalǵan A ' STUDIO toby! 2025 jyldyń 7 qarashasynda respýblıka saraıynyń sahnasynda mıllıondaǵan adamdardyń júregin jaýlap alǵan "Djýlıa", "ushyp ketý" jáne taǵy basqalar sıaqty súıikti hıtter shyrqalady. Osy keshte sizdi keremet atmosfera, jandy dybys jáne eń shynaıy ánder kútedi!
...
88	Deep Purple в Алматы	2026-04-22	Almaty Arena 2	20:00:00	Легендарное возвращение Deep Purple в Казахстан самое ожидаемое рок-событие года! Стань частью истории встреться с легендами. 22 апреля 2026 года в Алматы, Казахстан, мы рады приветствовать культовую британскую рок-группу Deep Purple с живым концертом на сцене Almaty Arena.\nДополнительно к вашему билету вы можете приобрести VIP-пакет Meet & Greet Upgrade на сайте группы.	/uploads/event_posters/86d47c7e-6917-49e0-96e4-ed5d6679e689.jpg	2000	1	3	2	21	Deep Purple in Almaty	Almatıdaǵy Deep Purple	Almaty Arena 2	Almaty Arena 2	The legendary return of Deep Purple to Kazakhstan is the most anticipated rock event of the year! Become part of history, meet the legends. On April 22, 2026, in Almaty, Kazakhstan, we are pleased to welcome the cult British rock band Deep Purple with a live concert on the stage of Almaty Arena. Additionally, you can purchase a VIP Meet & Greet Upgrade package on the band's website.	Deep Purple lėgendarlyq brıtanııalyq rok-tobynyń Qazaqstanǵa qaıta oralýy. Almaty Arena sahnasyndaǵy jandy daýystaǵy konsert — jyldyń eń kúshli rok-oqıǵasy.
70	Стендап-концерт Филиппа Воронина	2026-05-21	Almaty Central Stand up club	18:30:00	Филипп Воронин - стендап-комик, сценарист и ведущий шоу «Мне смешно». За время обучения в университете Филипп успел стать финалистом проекта «Comedy Баттл» на ТНТ, а также основать собственную команду «ДАЛС» в КВН, которая в дальнейшем прошла в Высшую лигу и запомнилась всем песней про конфетный вкус и другими яркими шутками.	static/eventPhoto/стендап_филипп.jpg	300	1	10	2	21	Philip Voronin Stand-up Concert	Fılıpp Voronınniń Stand-Up Konserti	Almaty Central Stand up club	Almaty Stand Up klýby	Philip Voronin is a stand-up comedian, screenwriter and host of the show "I'm Funny". During his university studies, Philip managed to become a finalist of the "Comedy Battle" project on TNT, as well as found his own team "DALS" in KVN.	Fılıpp Voronınniń stendap-konserti. «Comedy Battl» fınalısi jáne KVN-degi «DALS» tobynyń negizin qalaýshysynyń ázilder keshi.
62	Трон: Арес (2025)	2025-10-09	Chaplin Khan Shatyr, Проспект Туран, 37	10:00:00	"Трон: Арес” - это продолжение знаменитой научно-фантастической франшизы, которое перенесет зрителей в захватывающий и опасный мир цифровой сети, известной как Грид. События разворачиваются спустя годы после событий “Трона: Наследие”. Фильм рассказывает историю Ареса (Джаред Лето) - могущественного программного обеспечения, которое, по всей видимости, вышло из-под контроля и решило вторгнуться в человеческий мир. Он представляет собой нового, грозного антагониста, чьи мотивы и цели остаются загадкой. Фильм обещает зрелищные визуальные эффекты, динамичный экшн, а также исследование философских вопросов о природе сознания и границах технологий. “Трон: Арес” вернет зрителей в мир, который они любят, но при этом предложит новый взгляд на франшизу и ее персонажей.	static/eventPhoto/трон_арес.jpg	200	4	1	1	1	Tron: Ares (2025)	Tron: Ares (2025)	Chaplin Khan Shatyr	Chaplin Khan Shatyr	"Tron: Ares" is a continuation of the famous sci-fi franchise that will transport viewers to the exciting and dangerous world of the digital network known as the Grid. The film tells the story of Ares (Jared Leto), a powerful software that seems to have gone out of control and decided to invade the human world. It promises spectacular visual effects, dynamic action, and an exploration of philosophical questions about the nature of consciousness.	Tanymal fantastıkalyq franshızanyń jalǵasy. Munda Ares atty qýatty baǵdarlamalyq qamtamasyz etý adamzat álemine basyp kiredi. Fılm áserli vızýaldy effektiler men sana tabıǵatyn zertteýdi ýáde etedi.
66	Ǵashyqsyz ǵasyr	2025-10-17	Мангистауский драматический теарт им. Жантурина	19:00:00	Басты кейіпкерлері біздің замандастарымыз. 47 жастағы ғылым докторы, профессор Қайырбай мен 43 жастағы ғылым кандидаты Фарида жастай бірін-бірі сүйіп қосылған, төрт перзенті бар, кенжесі Жұлдыз мектептегі жоғары сынып оқушысы. Тұрмыстық-әлеуметтік жағдайы жақсы отбасы үшін пьеса сюжетіндегі шиеленісті жағдайы - Қайырбайдың ұлды болу мұратымен Нәзікеш есімді қызбен көңіл қосуы.Оқиғаның шиеленісті, шарықтау кездерінде Фарида мен Қайырбайдың қайта қауышу тағдырына әкеп соқтырады.	static/eventPhoto/гашиксыз_гасыр.jpg	1000	4	2	4	2	Century Without Love	Ǵashyqsyz ǵasyr	Zhanturin Mangystau Drama Theatre	Jantórın Atyndaǵy Mańǵystaý Drama Teatry	The main characters are our contemporaries. 47-year-old Doctor of Science Kayirbay and 43-year-old Candidate of Science Farida married for love in their youth and have four children. For a family with good socio-economic status, the conflict in the play's plot is Kayirbay's affair with a girl named Nazikesh due to his desire to have a son. The climax of the event leads to the destiny of Farida and Kayirbay reuniting.	Bizdiń zamandastarymyz Qaıyrbaı men Farıdanyń otbasylyq dramasy. Ul perzentti bolýdy armandaǵan Qaıyrbaıdyń basqa qyzben kóńil qosýy otbasynyń yntymaǵyna qaýip tóndiredi.
43	«САЦ» Гастроли	2025-11-05	пр.Н.Назарбаева, 19/1, Русский драматический театр им.Станиславского	18:30:00	«САЦ» - спектакль-реконструкция, основанный на реальных событиях. 7 ноября 1945 года в Алма-Ате остаётся всего один час до открытия первого театра для детей и юношества в Казахстане. На сцене идёт репетиция сказки Евгения Шварца «Красная Шапочка», режиссёр Наталия Ильинична Сац готовит актёров к премьере, в зале звучат голоса, за кулисами идут последние приготовления. В этой постановке оживают великие деятели прошлого: Вера Марецкая, Всеволод Мейерхольд, Евгений Вахтангов, Сергей Эйзенштейн, Николай Черкасов, Канабек Байсеитов, Курманбек Жандарбеков, юный Юрий Померанцев. История театра предстает перед зрителями как живой миф, где судьбы, встречи, творческие откровения и драматические повороты сливаются в единое полотно. В спектакле задействован звездный состав театра: в роли Наталии Ильиничны Сац - прима театра заслуженная артистка Казахстана Татьяна Тарская и заслуженный деятель Казахстана Татьяна Костюченко, в роли Веры Марецкой - народная артистка Казахстана Ольга Коржева, также в нем заняты молодые артисты театра. «САЦ» - это спектакль о легендарном времени, о силе искусства и о женщине, имя которой стало символом детского театра во всем мире. Это не просто воспоминание - это культурный код города, признание в любви к сцене и тем, кто её создавал.	static/eventPhoto/SACH.jpeg	500	2	2	5	3	"SATS" Tour	«SAC» gastrólderi	N. Nazarbayev Ave, 19/1, Stanislavsky Russian Drama Theatre	N. Nazarbaev Dańǵyly, 19/1, Stanıslavskıı Atyndaǵy Orys Drama Teatry	"SATS" is a reconstruction play based on real events. On November 7, 1945, in Alma-Ata, only one hour remains before the opening of the first theatre for children and youth in Kazakhstan. A rehearsal of Evgeny Schwartz's fairy tale "Little Red Riding Hood" is underway on stage; director Natalya Ilyinichna Sats is preparing actors for the premiere. In this production, great figures of the past come to life. "SATS" is a play about a legendary time, the power of art, and a woman whose name became a symbol of children's theatre worldwide.	Qazaqstandaǵy alǵashqy balalar teatrynyń ashylý tarıhy týraly spektakl-rekonstrýksııa. Bul — ónerdiń qudireti men Natalııa Sas týraly qoıylym.
45	ДО-ДЕС-КА-ДЭН	2025-10-26	Ақмола областық мәдениет басқармасы Шахмет Құсайынов атындағы областық қазақ музыкалық-драма театры	17:00:00	«ДОДЕСКАДЭН» түрлі тағдырларды арқау еткен, терең мағынаға толы тың туынды. Бұл шығарма Жапондық атақты кино режиссер Акира Куросаваның кино сценарийі желісі бойынша театр сахнасында тұңғыш рет сахналанды. Қойылым арқылы көрерменге тек әлеуметтік мәселе емес, адам болмысы, арман мен қиялдың құдыреті, жаны жаралы жандардың ішкі драмасы жеткізіледі. Мұндағы әр кейіпкердің жан тебіренісі үміт пен үнсіздік арасындағы үнсіз күрестің шуы. До-дес-ка-дэн жүрек дауысы. Мәртебелі көрермен, аталған спектакль камералық театр үлгісінде қойылған ерекше форматтағы туынды екенін ескеріңіз. Кейіпкерлер әлемін терең түсіну үшін спектакльді төрт тараптан, төрт рет тамашалау ұсынылады.	static/eventPhoto/do_des_ka_den.jpg	480	5	2	6	2	DO-DES-KA-DEN	DO-DES-KA-DEN	Shakhmet Kusayinov Regional Kazakh Music and Drama Theatre	Shahmet Qusaıynov Atyndaǵy Oblystyq qazaq Mýzykalyq Drama Teatry	"DO-DES-KA-DEN" is a deep work based on various destinies. This piece is staged for the first time in the theatre based on the screenplay by famous Japanese film director Akira Kurosawa. The performance conveys not only social issues but also human nature, the power of dreams and imagination, and the inner drama of wounded souls. Please note that this performance is staged in a chamber theatre format.	Akıra Kýrosavanyń kınossenaryıi jelisi boıynsha qoıylǵan tereń maǵynaly spektakl. Bul — adam bolmysy men arman qudireti týraly kameraulyq teatr nushasy.
53	Truwer в Алматы	2025-11-13	Дворец спорта им. Балуана Шолака	20:00:00	Truwer - казахстанский рэп-исполнитель, завоевавший популярность благодаря своим атмосферным трекам и глубоким текстам. Его музыка сочетает хип-хоп с элементами других жанров, создавая уникальное звучание. На концерте прозвучат как старые хиты, так и треки из новых релизов. Возрастное ограничение: 16+.	static/eventPhoto/truwer.png	3500	5	3	2	4	Truwer in Almaty	Almatıdaǵy Truwer	Baluan Sholak Sports Palace	Balýan Sholaq Atyndaǵy Sport Saraıy	Truwer is a Kazakhstani rap artist who gained popularity thanks to his atmospheric tracks and deep lyrics. His music combines hip-hop with elements of other genres, creating a unique sound. The concert will feature both old hits and tracks from new releases. Age restriction: 16+.	Qazaqstandyq rep-oryndaýshy Truwer-diń konserti. Onyń mýzykasy hıp-hopty basqa janrlarmen úılestiretin erekshe stılge ıe.
54	Симфонические телепортации - 2	2025-11-20	Концертный зал Государственной академической филармонии им Е.Рахмадиева	19:00:00	Торжественное открытие XXVII концертного сезона Симфонического оркестра. В программе прозвучат шедевры мировой классики, включая Концерт для скрипки с оркестром № 3 си минор Камиля Сен-Санса. Вечер станет подтверждением статуса Астаны как центра высоких художественных стандартов.	static/eventPhoto/symfonicheskie_telportachii.jpg	800	2	3	1	4	Symphonic Teleportations - 2	Sımfonııalyq teleportasııalar - 2	E. Rakhmadiev State Academic Philharmonic Concert Hall	E. Rahmadıev Atyndaǵy Memlekettik Akademıalyq Fılarmonıanyń Konsert Zaly	Grand opening of the XXVII concert season of the Symphony Orchestra. The program will feature masterpieces of world classics, including Camille Saint-Saens' Violin Concerto No. 3 in B minor. The evening will be a confirmation of Astana's status as a center of high artistic standards.	Sımfonııalyq orkestrdiń 27-shi konserttik maýsymynyń saltanatty ashylýy. Baǵdarlamada álemdik klassıka gýharshylary oryn alady.
63	Ash pen toq (2025)	2025-10-18	Chaplin Mega Almaty	10:00:00	Айдар и Эльдар — бывшие одноклассники, чьи жизни сложились по-разному: один — отец семейства без стабильного дохода, другой — успешный бизнесмен, лишённый родительского счастья. Случайная встреча перерастает в откровенный разговор, в котором каждый мечтает оказаться на месте другого. На следующее утро они просыпаются в телах друг друга. Вынужденные жить чужой жизнью, герои сталкиваются с неожиданными трудностями, меняющими их представление о счастье, успехе и настоящем богатстве.	static/eventPhoto/аш_пен_ток.jpg	300	5	1	2	1	The Hungry and The Full (2025)	Ash pen toq (2025)	Chaplin Mega Almaty	Chaplin Mega Almaty	Aidar and Eldar are former classmates whose lives turned out differently: one is a family man without a stable income, the other is a successful businessman deprived of parental happiness. A chance meeting turns into a frank conversation where each dreams of being in the other's place. The next morning they wake up in each other's bodies. Forced to live someone else's life, the heroes face unexpected difficulties that change their idea of happiness, success, and true wealth.	Aıdar men Eldar-burynǵy synyptastary, olardyń ómiri ártúrli joldarmen damydy: biri-turaqty tabysy joq otbasynyń ákesi, ekinshisi-ata-ana baqytynan aıyrylǵan tabysty kásipker. Kezdeısoq kezdesý ashyq áńgimege aınalady, onda árkim ekinshisiniń ornynda bolýdy armandaıdy. Kelesi kúni tańerteń olar bir-biriniń denesinde oıanady. Bireýdiń ómirimen ómir súrýge májbúr bolǵan keıipkerler kútpegen qıyndyqtarǵa tap bolyp, olardyń baqyt, sáttilik jáne qazirgi baılyq týraly túsinikterin ózgertedi.
55	Галым Калиакбаров - Stand Up концерт	2025-11-22	Алматы, Конкордия, Богенбай батыра 151	19:00:00	Большой сольный Stand Up концерт Галыма Калиакбарова в Алматы. Галым известен своим искрометным юмором, основанным на жизненных наблюдениях и национальной специфике. Зрителей ждет 1,5-2 часа смеха и позитива. Сбор гостей с 18:00, начало в 19:00.	static/eventPhoto/galym_kaliakbarov.png	550	6	4	2	9	Galym Kaliakbarov - Stand Up Concert	Ǵalym Qalıaqbarovtyń Stand-Up Konserti	Concordia, Bogenbai Batyr 151, Almaty	Konkordıa, Bógenbaı Batyr Kóshesi, 151, Almaty Q.	Big solo Stand Up concert of Galym Kaliakbarov in Almaty. Galym is known for his sparkling humor based on life observations and national specifics. The audience can expect 1.5-2 hours of laughter and positivity. Guests gather from 18:00, start at 19:00.	Ǵalym Qalıaqbarovtyń Almatydaǵy úlken jeke stendap-konserti. Ulttyq erekshelikter men kündelikti ómirge negizdelgen ázilder keshi.
56	Бағжан Октябрь с концертной программой «Терапия души»	2025-11-22	Дворец Спорта Балуан Шолак	20:00:00	Бағжан Октябрь представляет свою новую концертную программу «Терапия души». Его песни — это глубокие, лиричные истории, которые касаются самых потаенных струн души. Артист обещает незабываемый вечер, наполненный искренними эмоциями и качественной музыкой.	static/eventPhoto/terapia_dushi.jpg	3200	3	3	2	4	Bagzhan October: "Soul Therapy"	Baǵjan Oktábr"jan terapıasy" konserttik baǵdarlamasymen	Baluan Sholak Sports Palace	Balýan Sholaq Atyndaǵy Sport Saraıy	Bagzhan October presents his new concert program "Soul Therapy". His songs are deep, lyrical stories that touch the most secret strings of the soul. The artist promises an unforgettable evening filled with sincere emotions and quality music.	Baǵjan Oktıabrdiń «Terapııa dýshı» attı jańa konserttik baǵdarlamasy. Onyń ánderi — júrekke jol tabatyn lırıkalyq hıkaıalar.
67	Евгений Чебатков в Павлодаре	2025-12-11	ДК имени Естая	19:00:00	Новая программа «На других берегах» - это не просто набор шуток. Это цельное путешествие, в которое комик приглашает каждого зрителя. Путешествие по разным странам, культурам и, самое главное, по глубинам человеческих странностей и наблюдений. Евгений с присущей ему искренностью и острым умом поделится всем, что его удивило, рассмешило или заставило задуматься в последнее время. Если вы цените смелую, интеллигентную комедию и хотите на два часа забыть обо всем на свете, погрузившись в атмосферу качественного юмора, то этот концерт для вас. Не упустите шанс увидеть новое шоу одного из лучших стендап-комиков вживую!	static/eventPhoto/чебатков_павлодар.jpg	500	5	4	8	19	Evgeny Chebatkov in Pavlodar	Evgenıı Chebatkov Pavlodarda	Estay Palace of Culture	Estaı Mádenıet Saraıy	The new program "On Other Shores" is not just a set of jokes. It is a complete journey to which the comedian invites every viewer. A journey through different countries, cultures and, most importantly, the depths of human oddities. Evgeny will share everything that surprised, amused or made him think recently with his inherent sincerity. If you appreciate bold, intelligent comedy, this concert is for you.	Evgenıı Chebatkovtyń «Na drýgıh beregah» atty jańa baǵdarlamasy. Bul — álem elderi men adamnyń qyzyqty minez-qulyqtaryna baǵyttalǵan ıntellektýaldy komedııalyq kesh.
\.
...
204	26600	\N	91	20	Сцена
205	16000	\N	91	50	Входной
206	18000	\N	91	39	Танцпол
...
SELECT pg_catalog.setval('public.cards_token_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.events_event_id_seq', 91, true);
...
SELECT pg_catalog.setval('public.tickets_ticket_id_seq', 206, true);
